  ...
  return (
    <React.Fragment>
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 border border-gray-300 shadow-md shadow-gray-300 px-4 py-2 rounded-full">
          <div className="">Anywhere</div>

          <div className="border-l border-gray-300"></div>

          <div className="font-bold">Anytime</div>
        ...
        <div className="flex items-center gap-2 border border-gray-300  px-4 py-2 rounded-full overflow-hidden">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
